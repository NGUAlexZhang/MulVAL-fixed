...
{
       0,    63,    63,    64,    67,    68,    69,    70,    71,    74,
      75,    78,    83,    89,    96,   110,   152,   160,   174,   175,
     178,   189,   201,   217,   218,   219,   220,   221,   225,   229,
     233,   239,   240,   244,   251,   256,   264,   265,   273,   274,
     284,   295,   325
};
#endif
...
#line 79 "graphit.y"
                     {
                        _data.all_predicates.add_predicate( yyvsp[-5], atoi(yyvsp[-3]), 
                                      primitive);
                     }
#line 1220 "graphit.tab.c"
    break;
...
#line 1363 "graphit.tab.c"
    break;

  case 23: /* special_char: SP  */
#line 217 "graphit.y"
          {special_char_str=" ";}
#line 1369 "graphit.tab.c"
    break;

  case 24: /* special_char: '('  */
#line 218 "graphit.y"
          {special_char_str="(";}
#line 1375 "graphit.tab.c"
    break;

  case 25: /* special_char: ')'  */
#line 219 "graphit.y"
          {special_char_str=")";}
#line 1381 "graphit.tab.c"
    break;

  case 26: /* special_char: '['  */
#line 220 "graphit.y"
          {special_char_str="[";}
#line 1387 "graphit.tab.c"
    break;

  case 27: /* special_char: ']'  */
#line 221 "graphit.y"
          {special_char_str="]";}
#line 1393 "graphit.tab.c"
    break;
...
#line 296 "graphit.y"
              { 
                   ...
                   if( strlen(fact1_str) ==  0 ) {
                    ...
                    Predicate *p = 
                     _data.all_predicates.add_predicate( yyvsp[-3], arg_count, undef);
...
#line 1524 "graphit.tab.c"
    break;


#line 1528 "graphit.tab.c"
